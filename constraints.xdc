...
set_property PACKAGE_PIN T1 [get_ports {enter_limit}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {enter_limit}]
set_property PACKAGE_PIN R2 [get_ports {temp_type}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {temp_type}]
 

## LEDs
set_property PACKAGE_PIN U16 [get_ports {LED_racire}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LED_racire}]
set_property PACKAGE_PIN E19 [get_ports {LED_incalzire}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LED_incalzire}]
...
#	#set_property IOSTANDARD LVCMOS33 [get_ports {LED_heat}]
#set_property PACKAGE_PIN V14 [get_ports {led_cool}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {led_cool}]
#set_property PACKAGE_PIN V13 [get_ports {LED_racire}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {LED_racire}]
#set_property PACKAGE_PIN V3 [get_ports {LED_incalzire}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {LED_incalzire}]
...
set_property PACKAGE_PIN L1 [get_ports {LED_loaded_temp}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LED_loaded_temp}]
...
###Button
#set_property PACKAGE_PIN U18 [get_ports load_temp]						
	#set_property IOSTANDARD LVCMOS33 [get_ports load_temp]
set_property PACKAGE_PIN T18 [get_ports change]						
	set_property IOSTANDARD LVCMOS33 [get_ports change]
set_property PACKAGE_PIN W19 [get_ports time_up]						
    set_property IOSTANDARD LVCMOS33 [get_ports time_up]
set_property PACKAGE_PIN T17 [get_ports temp_up]						
	set_property IOSTANDARD LVCMOS33 [get_ports temp_up]
